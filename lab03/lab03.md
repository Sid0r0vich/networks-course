...
В языке go достаточно обернуть в горутину
...
Тут если не писать никаких проверок, просто никакая горутина не запустится
<img src="images/task4_img4.png" width=500 />
