...
#### Вопросы
1. Поверх какого протокола посылаются сообщения DHCP – UDP или TCP? **UDP**
   - <img src="images/task1_img1.png" width=600 />
2. Каков адрес канального уровня (т.е., Ethernet-адрес) у вашего хоста? **d8:80:83:76:df:19**
   - <img src="images/task1_img2.png" width=600 />
3. Каковы значения Transaction-ID в наборе (Request/ACK) DHCP-сообщений? **0xa12ff9a2** Опишите
   назначение поля Transaction-ID. **Сервер возвращает ответ с тем же id, чтобы клиент мог понять, что это ответ на его конкретный запрос.**
...
4. Хост использует DHCP-протокол, в частности, для получения IP-адреса. Но IP-адрес хоста
   ...
   передаваемые в инкапсулирующей IP-дейтаграмме DHCP сообщений **0.0.0.0; 255.255.255.255**
   - <img src="images/task1_img4.png" width=400 />
5. Каков IP-адрес вашего DHCP-сервера? **192.168.0.1**
   - <img src="images/task1_img5.png" width=500 />
6. Объясните назначение срока аренды IP-адреса. **ip-адресов небольшое количество, их нужно распределять по активным клиентам** Какова длительность срока аренды в вашем эксперименте? **2 часа**
...
#### Демонстрация работы
<img src="images/task4_img1.png" width=600 />
...
#### Демонстрация работы
<img src="images/task4_img2.png" width=500 />
