...
#### Вопросы
1. Каков IP-адрес вашего хоста? **192.168.0.103** Каков IP-адрес хоста назначения? **8.8.8.8**
   - <img src="images/task1_img1.png" width=200 />
2. Почему ICMP-пакет не обладает номерами исходного и конечного портов?
   **ICMP живёт на сетевом уровне, тогда как порты используются на транспортном**
3. Рассмотрите один из ping-запросов, отправленных вашим хостом. Каковы ICMP-тип **8** и кодовый
   номер **0** этого пакета? Какие еще поля есть в этом ICMP-пакете? **checksum, identifier, sequence number, data** Сколько байт приходится на поля 
   контрольной суммы, порядкового номера и идентификатора? **2**
   - <img src="images/task1_img2.png" width=200 />
   - <img src="images/task1_img3.png" width=400 />
4. Рассмотрите соответствующий ping-пакет, полученный в ответ на предыдущий. 
   Каковы ICMP-тип **0** и кодовый номер **0** этого пакета? Какие еще поля есть в этом ICMP-пакете? **checksum, identifier, sequence number, data**
   Сколько байт приходится на поля контрольной суммы, порядкового номера и идентификатора? **2**
...
1. Рассмотрите ICMP-пакет с эхо-запросом на вашем скриншоте. Отличается ли он от ICMP-пакетов
   с ping-запросами из Задания 1 (Ping)? Если да – то как? **размер data больше??**
...
2. Рассмотрите на вашем скриншоте ICMP-пакет с сообщением об ошибке. В нем больше полей,
   чем в ICMP-пакете с эхо-запросом. Какая информация содержится в этих дополнительных полях? **Заголовок отправленного пакета, его данные. Можно найти TTL**
   - <img src="images/task1_img6.png" width=400 />
   - <img src="images/task1_img8.png" width=400 />
3. Рассмотрите три последних ICMP-пакета, полученных исходным хостом. Чем эти пакеты
   отличаются от ICMP-пакетов, сообщающих об ошибках? **Сообщения об ошибках имеют тип 11, здесь тип 0** Чем объясняются такие отличия? **Эти пакеты пришли от конечного хоста**
   - <img src="images/task1_img7.png" width=400 />
4. Есть ли такой канал, задержка в котором существенно превышает среднее значение? Можете
   ...
   расположенных на обоих концах этого канала? **Задержка происходит между 4 и 5 маршрутизатором. Учитывая, что дальше идут маршрутизаторы Питера, могу предположить, что они где-то недалеко**
   - <img src="images/task1_img9.png" width=400 />
...
#### Демонстрация работы
<img src="images/task1_img10.png" width=400 />
...
#### Демонстрация работы
<img src="images/task1_img11.png" width=400 />
